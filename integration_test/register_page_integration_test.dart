...
import 'package:teste_widget/pages/register_page.dart';
...
void main() {
  ...
  group('testes do campo de email', () {
    testWidgets(
        'deve confirmar que o campo de email aparece corretamente na tela',
        (tester) async {
    ...
    testWidgets(
        'Deve exibir uma Snackbar com a mensagem de erro caso o email seja nulo',
        (tester) async {
      ...
      await tester.tap(registerButton); // seleciona o item que será clicado
      await tester
          .pumpAndSettle(); // renderiza na tela tudo o que acontece depois do clique do botao
